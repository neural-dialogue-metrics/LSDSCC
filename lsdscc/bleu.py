...
# ==============================================================================
"""
Various aligners that can be used in the computation of the alignment between
a hypothesis set and a annotated reference group.
"""
...
def _bleu_without_bp(
    ...
    assert len(reference_corpus) == len(
        translation_corpus
    ), "len of translations and references should match!"
